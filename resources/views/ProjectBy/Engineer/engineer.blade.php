...
<head>
    ...
    <title>ProjectBy - Engineer</title>
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="{{('projects') }}">Deployment</a>
                                <a class="collapse-item" href="{{('me_poc') }}">Proof-of-Concept</a>
                                <a class="collapse-item" href="{{('me_demo') }}">Product Demo</a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                <h6 class="collapse-header">Category:</h6>
                                <a class="collapse-item" href="{{('nt_deploy') }}">Deployment</a>
                                <a class="collapse-item" href="{{('nt_poc') }}">Proof-of-Concept</a>
                                <a class="collapse-item" href="{{('nt_demo') }}">Demo</a>
                    ...
                    <li class="nav-item active">
                        ...
                        <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item active" href="{{ ('engineer') }}" >Engineer</a>
                            </div>
                        </div>
                    </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Project By</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Engineer DataTables</h6>
                        </div>

                        {{-- <div class="card-header py-3">

                            <button type="button" data-toggle="modal" data-target="#DModal"
                            class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" >
                            <i class="fas fa-plus-square fa-sm text-white-50"></i> New Engineer</button>

                            <button  class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" id="" onclick="exportTableToCSV('Deployement List.csv')" >
                                ...
                                <table class="table table-bordered nowrap" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $staff->type }}</td>
                                            <td>
                                                <form action="{{ route('delete',$staff->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                        <div class="dropdown mb-4">
                                                            ...
                                                            <div class="dropdown-menu animated--fade-in"
                                                                ...
                                                                <a class="dropdown-item EditDModal" role="button"
                                                                data-toggle="modal" data-target="#EditDModal-{{ $staff->id }}">
                                                                <i class="fas fa-edit fa-sm fa-fw mr-2 text-gray-400"></i>
                                                                Edit</a>

                                                                <a class="dropdown-item ShowDModal" role="button"
                                                                data-toggle="modal" data-target="#ShowDModal-{{ $staff->id }}">
                                                                <i class="fas fa-eye fa-sm fa-fw mr-2 text-gray-400"></i>
                                                                Show</a>

                                                                {{-- <a class="dropdown-item" href="{{ route('engineer.destroy',$staff->id) }}" type="button"
                                                                onclick="return confirm('Are you sure you want to delete {{ $staff->position }} named {{ $staff->name }} from team {{ $staff->team }} ?')">
                                                            ...
                                                            {{-- <form action="{{ route('engineer.destroy',$staff->id) }}" method="POST">
...
@include('ProjectBy.Engineer.create')
{{-- @include('ProjectBy.Engineer.show')
@include('ProjectBy.Engineer.edit') --}}
