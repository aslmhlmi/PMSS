...
<head>
    ...
    <title>ManageEngine - Deployment</title>
                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <li class="nav-item active">
                        ...
                        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item active" href="{{('projects') }}">Deployment</a>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                <h6 class="collapse-header">Category:</h6>
                                <a class="collapse-item" url="">Deployment</a>
                                <a class="collapse-item" url="">Proof-of-Concept</a>
                                <a class="collapse-item" url="">Demo</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Deployment</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Deployment</h6>
                        </div>
                        ...
                        <div class="card-header py-3">
                            ...
                            <i class="fas fa-plus-square fa-sm text-white-50"></i> New Staff</button>
                        ...
                        <div class="card-body">
                                ...
                                <form  name="form1" method="post" id="store" action="{{ route('projects.update',$projects->id) }}">
                                {{ csrf_field() }}
                                    <div class="pl-lg-10">
                                        <div class="row">
                                        <div class="col-lg-2">
                                                <div class="form-group focused">
                                                    <label class="form-control-label" for="id" >No ID<span class="small text-danger">*</span></label>
                                                    <input type="text" id="id" class="form-control" name="id" placeholder="No ID" value=""  >
                                                </div>
                                            </div>
                                            <div class="col-lg-10">
                                                <div class="form-group focused">
                                                    <label class="form-control-label" for="team">POC/Demo/Tender<span class="small text-danger">*</span></label>
                                                    <input type="text" id="team" class="form-control" name="team" placeholder="Full Name" value="">
                                                </div>
                                            </div>
                                        </div>
